                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title float-right">
                                            <div class="btn-group" role="group">
                                                <a href="/data_laporan_edit/{{$value->kode_pengaduan}}" class="btn btn-sm  btn-shadow btn-success" data-toggle='tooltip' title="edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="/data_laporan_print/{{$value->kode_pengaduan}}" class="btn btn-sm btn-shadow btn-warning" data-toggle='tooltip' title="print">
                                                    <i class="fas fa-print"></i>
                                                </a>
                                                <a href="/data_laporan_lihat/{{$value->kode_pengaduan}}" class="btn btn-sm btn-shadow btn-info" data-toggle='tooltip' title="lihat">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="/data_laporan_hapus/{{$value->kode_pengaduan}}" class="btn btn-sm btn-shadow btn-danger delete-confirm" data-toggle='tooltip' title="hapus">
