	...
	<div class="row mt-5">
		<div class="col-md-4"></div>
            <div class="col-md-4 bg-light shadow-2 rounded">
                <div class="card-body ">
					<h1 class="card-title text-center"><br><h2><center><font class="text-primary"><b>Login</b></font></h2></h1>
					<p class="text-center" style="font-style: Helvetica">Sistem Layanan Pengaduan PJU Dinas Perhubungan Sambas</p> </center>    <hr>
